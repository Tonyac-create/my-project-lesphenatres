        ...
        <section className="flex flex-col mt-16 p-8 md:px-28 md:py-11 tracking-wide">
            ...
            <p className="text-lg md:text-xl">
                ...
                <p className="text-lg md:text-xl">
                    ...
                    nous y restons assez libres à l’intérieur.`}</p>
                ...
                {`Pourtant c’est avec cette méthode que nous réussissons à créer des histoires aussi formidable que rocambolesque et surtout nous ne sommes 
                jamais seul sur scène. Nos animateurs sont soit formé à l’animation ou ont assez d’expérience pour prendre en main les ateliers.
                Le théâtre est une grande famille où chaque personne est là pour l’autre sur scène et en coulisse, c’est dans cette optique là
