    ...
    return (
        <section className="relative p-8 md:px-28 md:py-11 tracking-wide">
            ...
            <div className="container mx-auto space-y-12 relative z-10 mt-12">
                <Moment 
                    title="Répétition Initiale" 
                    description="Première répétition..." 
                    image="/representation-phenatres.webp" 
                />
                <Moment 
                    title="Premier Spectacle" 
                    description="Un grand moment..." 
                    image="/nid-hibou.webp" 
                />
                <Moment 
                    title="Les Coulisses" 
                    description="Derrière chaque scène..." 
                    image="/ateliers-les-phenatres.webp" 
                />
            </div>
        </section>
    );
