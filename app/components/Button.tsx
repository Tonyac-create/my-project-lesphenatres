...
const Button: React.FC<ButtonProps> = ({ href, children, className, variant = 'primary' }) => {
  ...
  const variantClasses = variant === 'primary' ? 'bg-white text-black md:text-2xl shadow-[0_0_10px_rgba(51,51,51,1)] hover:shadow-[0_0_20px_rgba(51,51,51,1)] hover:bg-red hover:text-white' : 'bg-red text-white md:text-2xl shadow-[0_0_10px_rgba(192,10,50,1)] hover:shadow-[0_0_20px_rgba(192,10,50,1)] hover:bg-white hover:text-black';
