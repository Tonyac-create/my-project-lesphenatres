    ...
    return (
        <section className={`pt-12 sm:pt-20 mt-[5.875rem] tracking-wide sm:h-screen pb-14 sm:pb-0 bg-[url(/Rideau_theatre.webp)] bg-cover bg-center}`}>
            <div className={`flex flex-col justify-center items-center text-white transition-opacity duration-3000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                ...
                />
                <h2 className="font-dancing text-[2.25rem] md:text-5xl xl:text-6xl text-center mt-6">{`Le théâtre prend vie sous vos yeux !`}</h2>
                <p className="text-center mt-4 text-lg md:text-xl xl:text-2xl lg:w-[80%] xl:w-[60%]">{`Un espace où chacun progresse à son rythme, en s’amusant et sans prise de tête.
