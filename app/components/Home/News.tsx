    ...
    return (
        <section className="flex flex-col gap-6 p-8 md:px-28 md:py-11 tracking-wide">
            ...
            <div className="flex flex-col justify-center lg:flex-row gap-20 my-5">
                <Link href="https://www.facebook.com/lesphenatres" target="_blank" className="group inline-flex items-center gap-2 text-2xl hover:text-red">
                    <Image
                ...
                <Link href="https://www.tiktok.com/@lesphenatresdelartois?_t=ZN-8vLGTpttruQ&_r=1" target="_blank" className="group inline-flex items-center gap-2 text-2xl hover:text-red">
                    <Image
                ...
                <Link href="https://www.instagram.com/lesphenatresdelartois/?igsh=MXZwY21xeXZhOW80Ng%3D%3D#" target="_blank" className="group inline-flex items-center gap-2 text-2xl hover:text-red">
                    <Image
