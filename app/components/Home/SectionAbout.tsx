...
export default function SectionAbout() {
    return (
        <section className="flex flex-col md:flex-row items-center my-9 p-8 md:px-28 md:py-11 tracking-wide">
            <article className="lg:w-[50%] text-black p-5 mb-12 rounded-md">
                <h3 className="font-dancing text-red text-3xl sm:text-4xl mb-3.5 font-semibold">{`Comment est née l'association ?`}</h3>
                ...
                <p className="text-lg md:text-xl">{`Notre association a été créée en 2020, au tristement célèbre moment de la pandémie
                ...
                <p className="mt-3 mb-10 text-lg md:text-xl">{`Le nom de l'association “Les phénâtres de l'Artois” est un mélange des 2 mots...`}</p>
