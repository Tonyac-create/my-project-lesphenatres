...
export default function CardSpectacle({ pictures, title, description, description2, description3 }: spectacleProps) {
    ...
    return (
        <article>
            ...
            {/* Premières images (2) */}
            <div className="animation-down animation-down-1 flex flex-col md:flex-row gap-4 mb-3">
                {pictures.length >= 1 && (
            ...
            {/* Description */}
            <p className="animation-down animation-down-3 text-lg lg:text-xl lg:w-[80%] mb-3">{description}</p>

            {/* Images du milieu (2) */}
            <div className="animation-down animation-down-4 flex flex-col md:flex-row gap-14 mb-8">
            ...
            {/* Description 2 */}
            <p className="animation-down animation-down-5 text-lg lg:text-xl  lg:w-[80%] mb-3 italic">{`" ${description2} "`}</p>
            ...
            {/* Description 3 */}
            <p className="animation-down animation-down-7 text-lg lg:text-xl lg:w-[80%]">{description3}</p>
        </article>
    )
}